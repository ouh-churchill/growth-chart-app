...
(function(NS, $) {
    ...
    function getZScore( entry, prop ) {
        if (entry.hasOwnProperty(prop)) {
            ...
            if (ds) {
                ...
                var prec = GC.chartSettings.roundPrecision.zscore[GC.chartSettings.nicu ? "nicu" : "std"]
    ...
    function getDataSet( type ) {
        ...
        switch (type.toLowerCase()) {
            ...
            case "headc":
                return GC.DATA_SETS[ds + "_HEAD_CIRCUMFERENCE_INF"] || GC.DATA_SETS[ds + "_HEAD_CIRCUMFERENCE"] ||
                GC.DATA_SETS[ds + "_HEADC"];
        }
    }
