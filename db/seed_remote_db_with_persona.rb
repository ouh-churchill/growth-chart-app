...
# Method to add Smart Apps to the database :
# persona can be a string with values : 'provider' or 'patient'
def smart_app(app_id, name, authorized, fhir_server_id, launch_url, persona)
  { app: {
      app_id: app_id, name: name, launch_url: launch_url, authorized: authorized,
      igneous_smart_fhir_server_id: fhir_server_id, persona: persona }
  }.to_json
end
